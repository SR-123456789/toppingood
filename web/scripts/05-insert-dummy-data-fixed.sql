...
DELETE FROM public.mimics WHERE user_id IN (
  '11111111-1111-1111-1111-111111111111',
  '22222222-2222-2222-2222-222222222222',
  '33333333-3333-3333-3333-333333333333',
  '44444444-4444-4444-4444-444444444444',
...
INSERT INTO public.posts (id, user_id, menu_name, topping_content, memo, image_urls, mimic_count, like_count, created_at, updated_at) VALUES
  (
    ...
    ARRAY['/placeholder.svg?height=300&width=300', '/placeholder.svg?height=300&width=300&text=2'],
    24,
    45,
  ...
  (
    ...
    ARRAY['/placeholder.svg?height=300&width=300', '/placeholder.svg?height=300&width=300&text=2', '/placeholder.svg?height=300&width=300&text=3'],
    156,
    89,
